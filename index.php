...
async function doLogin() {
    ...
    // Gọi API đăng nhập
    const result = await fetchAPI('/flashcard/api/login.php', { email, password: pass });
...
async function doRegister() {
    ...
    const result = await fetchAPI('/flashcard/api/register.php', { full_name, email, password });
