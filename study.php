...
.study-wrapper { min-height: calc(100vh - 60px); }
#study-done    { display: none; flex-direction: column; align-items: center; justify-content: center; min-height: 60vh; }
</style>
            ...
            <div class="flip-scene" onclick="flipCard()" title="Click để xem đáp án">
                <div class="flip-card" id="flip-card">
                    ...
                    <div class="flip-front">
                        ...
                        <div class="hint">👆 Click để xem đáp án</div>
                    </div>
